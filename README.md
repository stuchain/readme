...
<p align="center"><i>Live stats and activity — refresh when you load the page.</i></p>
...
<details>
<summary><strong>Stats cards missing or broken?</strong></summary>

Public APIs can rate-limit or error. These cards use [GitHub Profile Summary Cards](https://github.com/vn7n24fzkq/github-profile-summary-cards) and [Streak Stats](https://github.com/DenverCoder1/github-readme-streak-stats). If they fail, fork [github-readme-stats](https://github.com/anuraghazra/github-readme-stats) or [summary cards](https://github.com/vn7n24fzkq/github-profile-summary-cards) to Vercel and point the `<img>` URLs at your deployment.
...
<sub>Snake SVGs are generated by Actions: <strong>daily</strong> (~03:00 UTC) and when you <strong>push</strong> to <code>main</code> (ignoring bot-only <code>dist/</code> commits). Commits to other repos still appear on the next run.</sub>
...
| **Backend & data** | Rust (axum, tokio) · Python services · SQLite (sqlx) · MQTT pipelines |
| **Chain & security** | Hardhat · Solidity · local chains · Solana demos · cryptography & protocols |
| **DevOps** | Docker · GitHub Actions · PowerShell · bash |
